...
G\+S\+L V\+E\+G\+A\+S algorithm. This is my attempt to convert it to a parallel version using the Open\+M\+P A\+P\+I. As long as the integrand function is thread-\/safe it works correctly. Experimental and not used in the main program.  
